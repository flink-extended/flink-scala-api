...
/** Internal wrapper class to map a Flink's Java API [[org.apache.flink.streaming.api.functions.async.ResultFuture]] to
  * a Scala [[org.apache.flink.streaming.api.scala.async.ResultFuture]].
  *
  ...
  */
@Internal
class JavaResultFutureWrapper[OUT](val javaResultFuture: async.ResultFuture[OUT]) extends ResultFuture[OUT] {
