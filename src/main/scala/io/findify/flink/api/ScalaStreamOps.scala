...
object ScalaStreamOps {
  ...
  /** Converts an [[org.apache.flink.streaming.api.datastream.DataStream]] to a [[io.findify.flink.api.DataStream]].
    */
  def asScalaStream[R](stream: JavaStream[R]) = new DataStream[R](stream)

  /** Converts an [[org.apache.flink.streaming.api.datastream.KeyedStream]] to a [[io.findify.flink.api.KeyedStream]].
    */
  ...
  /** Converts an [[org.apache.flink.streaming.api.datastream.ConnectedStreams]] to a
    * [[io.findify.flink.api.ConnectedStreams]].
    */
  ...
  /** Converts an [[org.apache.flink.streaming.api.datastream.BroadcastConnectedStream]] to a
    * [[io.findify.flink.api.BroadcastConnectedStream]].
    */
